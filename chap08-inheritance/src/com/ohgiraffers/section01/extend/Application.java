...
public class Application {
    public static void main(String[] args) {
         ...
         * 클래스 또한 부모클래스와 자식클래스로 역할을 나우어서 부모가 가지는 멤버를 자식이 물려받아
         * 가지의 멤버인 거처럼 사용할 수 있도록 만든 기술이다.
         *
         ...
         *    상속 구조가 복잡해질수록 그 영향에 대한 예측이 힘들어 이런 단점이 유지보수성이 증가한다는 장점과는 반대로
         *    유지보수에 악영향을 미친다.
         ...
         * 적절한 책임을 가진 객체들이 서로 협력(메세지 수시관 응답)을 통해 프로그램이 동작하는 것을
         * 객체지향 프로그램이라고 한다.
         * */

        /*
         * 적절한 책임을 수행하는 객체 또한 그 객체만 수행할 수 있는 기능이라기 보다 역할이 관점으로 바라봐야한다.
         ...
         * 동일한 역할을 가지는 모든 객체는 동일한 메세지를 수신하기는 하지만 객체별로 그 메세지에 응잡하는 방식이
         * 서로 다를 수 있다.
         * */
