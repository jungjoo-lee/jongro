...
public class Application3 {
    public static void main(String[] args) {
        ...
        /* 1. 전달인자로 값 전달 테스트 */
        app.testMethod(40);
        //app.testMethod("40");         // 매개변수는 int형이지만 인자 String이기 때문에 호출할 수 없다.
        //app.testMethod(20, 30, 40);   // 매개변수는 int이지만 인자는 3개이기 때문에 호출할 수 없다.
        ...
        long longAge = 80;
        //app.testMethod(longAge); // 자동 형변환을 할 수 없어서 에러발생
        app.testMethod((int)longAge); // 데이터 손실의 주의
