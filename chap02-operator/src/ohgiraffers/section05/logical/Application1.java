...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 논리AND 연산자 결과값 확인 */
        System.out.println("========== 논리AND 연산자 결과값 확인 ==========");
        ...
        /* 논리OR 연산자 결과값 확인 */
        System.out.println("========== 논리OR 연산자 결과값 확인 ==========");
        ...
        /* 논리 부정 연산자 결과값 확인 */
        System.out.println("========== 논리 부정 연산자 결과값 확인 ==========");
        System.out.println("true의 논리! 부정 연산 : " + !true);
        System.out.println("false의 논리! 부정 연산 : " + !false);
        System.out.println();
