...
public class Application3 {
    public static void main(String[] args) {
        ...
        *   2-8 boolean 형은 의문문으로 가급적 긍정형태로 네이밍 한다.
        ...
        //String age = ""; // 자료형 타입이 달라도 변수명을 같게 할 수 없다.
        ...
        int sadkgjhkljhxzckjhkgljhdrfkjhgkfdjhgkjfhc;
        ...
        /* 목차 2-3 단어와 단어 사이의 연결은 언더스코어(_)로 사용하지 않는다. */
        String user_name; // 에러발생하진 않지만 이렇게 하면 안된다.
        String userName; // 이게 올바른 표기법이다.

        /* 목차 2-4 한글로 변수명을 짓는 것은 가능하지만 권장하지 않는다.(매우) */
        int 나이;
        ...
        /* 목차 2-8 boolean 형은 의문문으로 가급적 긍정형태로 네이밍 한다. */
