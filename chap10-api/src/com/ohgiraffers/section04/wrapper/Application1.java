...
public class Application1 {
    public static void main(String[] args) {
         ...
         * 8가지의 해당하는 기본타입의 데이터를 인스턴스화 할 수 있도록 하는 클래스를 리퍼클래스라고 한다.
         * (주변에서 사용하는 램(Wrap)과 같은 형태로 감싼다는 뜻이다)
         */
         ...
         * */
        int inValue = 20;
        Integer boxingNum1 = new Integer(inValue); // 인스턴스화 - 박싱 // 생성자 이용
        Integer boxingNum2 = Integer.valueOf(inValue); // static 메소드 이용
        ...
        Integer boxingNum3 = inValue; // 오토박싱
