...
public class kindsOfVariable { // 클래스 영역의 시작
    ...
    /*
     * non-static field 를 인스턴스 변수라고 한다.(인스턴스 생성 시점에서 사용가능한 변수라는 의미)
     */

    private int globalNum;

    /* static field 를 정적필드(클래스변수)라고 한다. 정적(클래스)영역에 생성되는 변수라는 의미이다. */
    ...
    public void testMethod(int num) { // 메소드 영역의 시작
        ...
        /* 지역변수는 선언 외에 사요(호출하기 위해서는 반드시 초기화가 되어야한다.) */
