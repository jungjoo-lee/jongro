...
public class Application1 {
    public static void main(String[] args) {
         ...
         *    이런 동일한 메시지를 수신받아 처리하는 내용을 객체별로 다르게 할 수 있다는 장점을 가지고 있다.
         ...
         * 런타임 당시의 실제 객체가 가지 오버라이딩된 메소드로 바인딩이 바뀌어 동작하는 것을 의미한다.
         */
        a1.cry();
        a2.cry();
        ...
        System.out.println("a1이 Tiger 타입인 확인 : " + (a1 instanceof Tiger));
        System.out.println("a1이 Rabbit 타입인 확인 : " + (a1 instanceof Rabbit));
        System.out.println("a1이 Animal 타입인 확인 : " + (a1 instanceof Animal));
        System.out.println("a1이 Object 타입인 확인 : " + (a1 instanceof Object));
